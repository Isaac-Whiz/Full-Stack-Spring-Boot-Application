...
import {saveGamer} from "../../services/client.js";
...
const CreateGamerForm = ( {fetchGamers}) => {
    return (
        <>
            <Formik
                initialValues={{
                ...
                onSubmit={(gamer, { setSubmitting }) => {
                    setSubmitting(true);
                    saveGamer(gamer)
                        .then(res => {
                            successNotification("Success", `${gamer.name} saved successfully.`);
                            fetchGamers();
                        })
                        .catch(err => {
...
export default CreateGamerForm;